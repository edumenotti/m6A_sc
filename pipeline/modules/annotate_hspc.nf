process ANNOTATE_HSPC {
    tag "annotate_hspc"
    publishDir "${params.outdir}/06_annotate_hspc", mode: 'copy'
    memory '32 GB'
    cpus 4
    accelerator 1
    ...
    pixi run -m ${projectDir}/../pixi.toml -e popv python ${projectDir}/scripts/06_annotate.py \
        ...
        --ref ${ref_h5ad} \
        --out . \
        --ref-labels-key ${params.hspc_ref_labels_key} \
        --ref-batch-key ${params.hspc_ref_batch_key} \
